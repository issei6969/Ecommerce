...
<html lang="en">
    ...
    <style>
        #navigation {
            background: linear-gradient(to right, #fcdf49, #FF4E50); 
                               ...
                               <div class="dropdownn">
                                ...
                                <div class="dropdownn">
                                  ...
                                  <div class="dropdownn-content">
                                    ...
                                    <a href="../online-shopping-system/admin/index.php" data-toggle="modal"><i class="fa fa-sign-in" aria-hidden="true"></i>Admin Login</a>
